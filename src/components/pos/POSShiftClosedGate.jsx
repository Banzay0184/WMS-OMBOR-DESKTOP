    ...
    <div className="w-full max-w-md rounded-2xl bg-white border border-border shadow-xl p-6 space-y-4 text-center">
      ...
      <div>
        ...
        <p className="text-sm text-muted mt-2">
          На выбранном складе Z-отчёт уже сформирован сегодня. Повторно открыть смену на этом
          складе могут только администраторы платформы в панели разработчика. Обычные пользователи
          POS смогут работать завтра или на другом складе.
        </p>
